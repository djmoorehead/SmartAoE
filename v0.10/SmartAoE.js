        ...
        try {
            ...
            if(msg.type=="api" && msg.content.toLowerCase().indexOf("!smartaoe")==0) {
                ...
                spawnObj.get("_defaulttoken", async function(defaultToken) {
                    ...
                    //log(controlTok);
                    let pathstring = buildSquare(35*pageGridIncrement);
                    //log(pathstring);
                    ...
                    */
                    ...
                    if (path) {
                        ...
                        let newLink = makeAoELink(aoeType, aoeColor, range, originType, oPt, minGridArea, minTokArea, oTok.get('_id'), controlTok.get('_id'), path.get('_id'), controlTok.get('_pageid'), fxType, saveFormula, saveName, DC, damageBar, autoApply, damageFormula1, damageFormula2, damageBase1, damageBase2, damageType1, damageType2, rollDamage1, rollDamage2, conditionPass, conditionFail, cardParameters);
